CREATE OR REPLACE PACKAGE PKG_FDR_REWARDS_STAGING_R AS
    ...
    ******************************************************************************/
    ...
    /******************************************************************************
    *
    *  Title:        PKG_FDR_REWARDS_STAGING_R.STAGE_REWARD_MSTR
    *  Schema Owner: ODS_STG
    *  Created:      March 27, 2020  07:19:15
    *  Author:       CMENDOZA
    *
    ...
    ******************************************************************************/
    ...
    /******************************************************************************
    *
    *  Title:        PKG_FDR_REWARDS_STAGING_R.STAGE_REWARD_REDEMPTION
    *  Schema Owner: ODS_STG
    *  Created:      March 27, 2020  07:19:15
    *  Author:       CMENDOZA
    *
    ...
    ******************************************************************************/
    ...
    /******************************************************************************
    *
    *  Title:        PKG_FDR_REWARDS_STAGING_R.STAGE_REWARD_TRANSACTION
    *  Schema Owner: ODS_STG
    *  Created:      March 27, 2020  07:19:15
    *  Author:       CMENDOZA
    *  Author:       CMENDOZA
...
CREATE OR REPLACE PACKAGE BODY PKG_FDR_REWARDS_STAGING_R AS

	/******************************************************************************
    *
    *  Title:       PKG_FDR_REWARDS_STAGING_R.log_update
    ...
    ******************************************************************************/
    ...
    /******************************************************************************
        *
        *  Title:       PKG_FDR_REWARDS_STAGING_R.fdr_notification
        *  Created:     07/03/2020
        *  Author:     cmendoza
        *
        ...
        ELSE
            ...
            USING (SELECT tc.CREDIT_ACCOUNT_ID,
                    ...
                    INNER JOIN T_REWARDS_PRODUCT rp
                       ON rp.product_id = ca.rewards_product_id) src
...
GRANT EXECUTE ON PKG_FDR_REWARDS_STAGING_R TO ODS_STG;