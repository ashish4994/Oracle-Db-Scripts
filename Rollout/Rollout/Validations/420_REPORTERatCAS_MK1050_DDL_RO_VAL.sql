/*
  Script:      420_REPORTERatCAS_MK1050_DDL_RO_VAL.sql
...
spo 420_REPORTERatCAS_MK1050_DDL_RO_VAL_&filename1..log;
...
BEGIN
  ...
  IF v_count = 1 THEN
    DBMS_OUTPUT.PUT_LINE('V_REWARDS_SIX_FLAGS view is created in the database');
  ELSE
    raise_application_error(-20002,
                            'V_REWARDS_SIX_FLAGS IS NOT in the database! Validation FAILED');
  END IF;
