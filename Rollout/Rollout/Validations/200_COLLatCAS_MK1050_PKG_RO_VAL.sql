/*
  Script:      200_COLLatCAS_MK1050_PKG_RO_VAL.sql
...
spo 200_COLLatCAS_MK1050_PKG_RO_VAL_&filename1..log;
...
DECLARE
  ...
  V_COUNT        NUMBER;
  V_OWNER		 VARCHAR2(20) := 'COLL';
  V_STATUS_VALID VARCHAR2(20) := 'VALID';
  V_PACKAGE_NAME VARCHAR2(50) := 'pkg_coll_account_info_p';
  
BEGIN

  -- RO Validation for pkg_coll_account_info_p.
  SELECT COUNT(1)
    INTO V_COUNT
    FROM DBA_OBJECTS
  WHERE OBJECT_NAME = upper(V_PACKAGE_NAME)
     AND OWNER = V_OWNER
