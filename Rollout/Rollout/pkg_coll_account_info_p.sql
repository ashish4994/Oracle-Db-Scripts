CREATE OR REPLACE PACKAGE COLL.PKG_COLL_ACCOUNT_INFO_P IS
...
END PKG_COLL_ACCOUNT_INFO_P;
/
CREATE OR REPLACE PACKAGE BODY COLL.PKG_COLL_ACCOUNT_INFO_P IS
    /******************************************************************************
    *
    ...
    **********************************************************************************/
    ...
    /******************************************************************************
	  ...
	  *	   01/27/2021	 LTAMIOZZO			 MK-1050: Add INTERNAL_PRODUCT_NAME to response model.
      ******************************************************************************/
    PROCEDURE pr_get_account_data(pcard_number IN account.card_number%TYPE,
                                  pref_cursor  OUT SYS_REFCURSOR) AS
        v_systemcode            NUMBER;
    ...
    BEGIN
        ...
        *************************************/
		...
		BEGIN
			...
			WHERE tc.card_num = pcard_number;
			EXCEPTION
				WHEN NO_DATA_FOUND THEN
